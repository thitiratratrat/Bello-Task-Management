...
class SignUpWidget(QWidget):
    def __init__(self):
        ...
        self.usernameLabelSignUp.setFont(QFont("Century Gothic", 11,QFont.Bold))
        self.usernameValueSignUp = QLineEdit()
        self.passwordLabelSignUp = QLabel("Password: ")
        self.passwordLabelSignUp.setFont(QFont("Century Gothic", 11,QFont.Bold))
        self.passwordValueSignUp = QLineEdit()
        self.confirmPasswordLabel = QLabel("Confirm Password: ")
        self.confirmPasswordLabel.setFont(QFont("Century Gothic", 11,QFont.Bold))
        ...
        self.signUpBtn.setStyleSheet("background-color:rgb(250,231,110);color:rgb(49,68,111)")
        ...
        self.formSignUpLayout.addRow(self.usernameLabelSignUp, self.usernameValueSignUp)
        self.passwordLabelSignUp.setContentsMargins(30,0,10,15)
        self.passwordValueSignUp.setContentsMargins(0,0,30,15)
        self.formSignUpLayout.addRow(self.passwordLabelSignUp, self.passwordValueSignUp)
        self.confirmPasswordLabel.setContentsMargins(30,0,10,20)
        self.confirmPasswordValue.setContentsMargins(0,0,30,20)
        self.formSignUpLayout.addRow(self.confirmPasswordLabel,self.confirmPasswordValue)
        self.gridSignUpLayout.addLayout(self.formSignUpLayout,0,0)
        self.gridSignUpLayout.addWidget(self.signUpBtn,1,0,1,1,Qt.AlignCenter)
